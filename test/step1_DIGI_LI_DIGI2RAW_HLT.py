...
# with command line options: step1 --filein=/store/user/algomez/RPVSt100tojj_13TeV_pythia8_GENSIM/RPVSt100tojj_13TeV_pythia8_GENSIM/62459d50bdc5c4568f334137235e3bfc/RPVSt100tojj_13TeV_pythia8_GEN_1000_2_cof.root --fileout file:FSQ-Spring14dr-00072_step1.root --pileup_input dbs:/MinBias_TuneA2MB_13TeV-pythia8/Fall13-POSTLS162_V1-v1/GEN-SIM --mc --eventcontent RAWSIM --pileup AVE_20_BX_25ns --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --conditions POSTLS170_V5::All --step DIGI,L1,DIGI2RAW,HLT:2013,RAW2DIGI,L1Reco --magField 38T_PostLS1 --geometry DBExtendedPostLS1 --python_filename step1_test.py --no_exec -n 24
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(24)
)

# Input source
process.source = cms.Source("PoolSource",
    secondaryFileNames = cms.untracked.vstring(),
    fileNames = cms.untracked.vstring('/store/user/algomez/RPVSt100tojj_13TeV_pythia8_GENSIM/RPVSt100tojj_13TeV_pythia8_GENSIM/62459d50bdc5c4568f334137235e3bfc/RPVSt100tojj_13TeV_pythia8_GEN_1000_2_cof.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('step1 nevts:24'),
