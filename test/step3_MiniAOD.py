...
# with command line options: miniAOD-prod -s PAT --eventcontent MINIAODSIM --runUnscheduled --mc --filein file:FSQ-Spring14dr-00074_step2.root --conditions PLS170_V7AN1::All --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:Spring14dr-00074_step2.root')
)
